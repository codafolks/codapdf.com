      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            By accessing or using CodaPDF ("Service"), you agree to be bound by
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            CodaPDF provides a platform to convert HTML templates into PDFs
            using REST API. We offer various subscription plans: Hobby, Basic,
            Pro, and Enterprise.
          </p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Details of each plan, including features and limitations, are
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Subscriptions are billed on a recurring basis as per the
                selected plan.
              </p>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">
                You may cancel your subscription at any time. Refund policies
                are outlined in our Refund Policy.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                You may not misuse the service by transmitting viruses, spam, or
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            In no event shall CodaPDF be liable for any indirect, incidental,
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            You agree to defend, indemnify, and hold harmless CodaPDF from and
