...
export const Home = () => (
  <section
    className="w-full py-6 md:py-8 lg:py-10 xl:py-48 bg-background text-foreground relative"
    id="home"
  >
      ...
      <div className="flex flex-col items-center space-y-4 text-center ">
        <div className="space-y-2">
          ...
          <p className="mx-auto max-w-[800px] md:text-xl">
            A developer-friendly API to quickly convert HTML templates into
            PDFs. Plus, a slick dashboard to help you keep track and manage
            everything smoothly.
          </p>
        </div>
