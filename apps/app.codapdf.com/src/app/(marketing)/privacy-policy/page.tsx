      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Welcome to CodaPDF ("we", "our", or "us"). We are committed to
            protecting your personal information and your right to privacy. This
            Privacy Policy explains how we collect, use, and safeguard your
            information when you visit our website https://dev.codapdf.com and
            use our services.
          </p>
        </section>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                registering for an account or subscribing to a plan.
              </p>
              <p className="text-muted-foreground mt-2 italic">
                Note: We do not collect your address information.
              </p>
            </div>
            <div>
              <h3 className="font-medium mb-2">Billing Information:</h3>
              <p className="text-muted-foreground">
                All billing information is collected and processed by our
                third-party payment processor, Stripe. CodaPDF does not store or
                have access to your billing information.
              </p>
            </div>
            <div>
              <h3 className="font-medium mb-2">Usage Data:</h3>
              <p className="text-muted-foreground">
                IP address, browser type, pages visited, time and date of visit,
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                To assist us in providing and improving our service, such as
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground">
            ...
            destruction. Billing information is securely processed by Stripe,
            and we rely on their security protocols to protect your billing
