...
type TextareaControllerProps<T extends FieldValues> = Omit<TextareaProps, "name"> & {
  control: Control<T, object>;
  name: Path<T>;
};

const TextareaController = <T extends FieldValues>({ name, control, ...rest }: TextareaControllerProps<T>) => {
  const {
    fieldState: { error },
